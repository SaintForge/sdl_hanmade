...
cl /nologo /EHsc -Zi win32_platform.cpp -DASSET_BUILD -DDEBUG_BUILD /I%SDL2LIB%"/include" /link /LIBPATH:%SDL2LIB%/lib/x64 SDL2main.lib SDL2.lib  SDL2_image.lib SDL2_ttf.lib SDL2_mixer.lib
